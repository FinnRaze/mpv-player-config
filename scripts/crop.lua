-- crop unavaliable under native hwdec,need "-copy" or software decode
-- 插入裁剪滤镜，原生硬解下无法生效，需-copy硬解或软解
...
local hwdec = mp.get_property_native("hwdec")
...
function on_press()
    ...
    -- change hwdec    
    if hwdec ~= "auto-copy" then
        mp.set_property_native("hwdec","auto-copy")
    end        
...
mp.add_key_binding("P", "toggle_crop", on_press)
